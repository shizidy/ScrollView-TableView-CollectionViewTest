...
@interface HomeViewController () <ContentMenuViewDelegate, HeaderMenuViewDelegate, SideMenuViewDelegate>
...
//    self.headerView = [[HeaderMenuView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.allButtonView.frame), kNavigationBarHeight, kScreenWidth - CGRectGetMaxX(self.allButtonView.frame), CGRectGetHeight(self.allButtonView.frame))];
    self.headerView = [[HeaderMenuView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.allButtonView.frame), kNavigationBarHeight, kScreenWidth - CGRectGetMaxX(self.allButtonView.frame), CGRectGetHeight(self.allButtonView.frame)) delegate:self];
